...
#import "KKHorizontalPageableLayout.h"

@interface KKHorizontalPageableLayout () <UICollectionViewDelegateFlowLayout>

@property (nonatomic, strong) NSMutableArray *allAttributes;

@end

@implementation KKHorizontalPageableLayout
